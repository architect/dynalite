...
exports.custom = function (data) {
  ...
  for (key in data.AttributeUpdates) {
    if (data.AttributeUpdates[key].Value != null) {
      msg = validations.validateAttributeValue(
        data.AttributeUpdates[key].Value
      );
      if (msg) return msg;
    }
    if (
      data.AttributeUpdates[key].Value == null &&
      data.AttributeUpdates[key].Action != "DELETE"
    )
      return (
    ...
    if (
      data.AttributeUpdates[key].Value != null &&
      data.AttributeUpdates[key].Action == "ADD"
    ) {
