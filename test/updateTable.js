...
describe("updateTable", function () {
  describe("serializations", function () {
    ...
    it("should return SerializationException when ProvisionedThroughput is not a struct", function (done) {
      assertType(
        ...
        "FieldStruct<ProvisionedThroughput>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0 is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0",
        "ValueStruct<GlobalSecondaryIndexUpdate>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Update is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Update",
        "FieldStruct<UpdateGlobalSecondaryIndexAction>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Update.IndexName is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Update.IndexName",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput",
        "FieldStruct<ProvisionedThroughput>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput.WriteCapacityUnits is not a long", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput.WriteCapacityUnits",
        "Long",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput.ReadCapacityUnits is not a long", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Update.ProvisionedThroughput.ReadCapacityUnits",
        "Long",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create",
        "FieldStruct<CreateGlobalSecondaryIndexAction>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.IndexName is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.IndexName",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput",
        "FieldStruct<ProvisionedThroughput>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput.WriteCapacityUnits is not a long", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput.WriteCapacityUnits",
        "Long",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput.ReadCapacityUnits is not a long", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.ProvisionedThroughput.ReadCapacityUnits",
        "Long",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.KeySchema is not a list", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.KeySchema",
        "List",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.KeySchema.0 is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.KeySchema.0",
        "ValueStruct<KeySchemaElement>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.KeySchema.0.AttributeName is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.KeySchema.0.AttributeName",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.KeySchema.0.KeyType is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.KeySchema.0.KeyType",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.Projection is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.Projection",
        "FieldStruct<Projection>",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.Projection.NonKeyAttributes is not a list", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.Projection.NonKeyAttributes",
        "List",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.Projection.ProjectionType is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.Projection.ProjectionType",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Create.Projection.NonKeyAttributes.0 is not a string", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Create.Projection.NonKeyAttributes.0",
        "String",
        done
      );
    });
    ...
    it("should return SerializationException when GlobalSecondaryIndexUpdates.0.Delete is not a struct", function (done) {
      assertType(
        "GlobalSecondaryIndexUpdates.0.Delete",
        "FieldStruct<DeleteGlobalSecondaryIndexAction>",
        done
      );
    });
  ...
  describe("validations", function () {
    ...
    it("should return ValidationException for empty ProvisionedThroughput", function (done) {
      assertValidation(
        { TableName: "abc", ProvisionedThroughput: {} },
        [
      ...
      assertValidation(
        {
          TableName: "abc",
          ProvisionedThroughput: {
            ReadCapacityUnits: 1000000000001,
            WriteCapacityUnits: -1,
          },
        },
        "1 validation error detected: " +
      ...
      assertValidation(
        {
          ...
          ProvisionedThroughput: {
            ReadCapacityUnits: 1000000000001,
            WriteCapacityUnits: 1000000000001,
          },
        },
        "Given value 1000000000001 for ReadCapacityUnits is out of bounds",
        done
      );
    });
      ...
      assertValidation(
        {
          TableName: "abc",
          ProvisionedThroughput: {
            ReadCapacityUnits: 1000000000000,
            WriteCapacityUnits: 1000000000001,
          },
        },
        "Given value 1000000000001 for WriteCapacityUnits is out of bounds",
        done
      );
    });
    ...
    it("should return ValidationException for empty GlobalSecondaryIndexUpdates", function (done) {
      assertValidation(
        { TableName: "abc", GlobalSecondaryIndexUpdates: [] },
        "At least one of ProvisionedThroughput, BillingMode, UpdateStreamEnabled, GlobalSecondaryIndexUpdates or SSESpecification or ReplicaUpdates is required",
        done
      );
    });
    ...
    it("should return ValidationException for empty Update", function (done) {
      assertValidation(
        { TableName: "abc", GlobalSecondaryIndexUpdates: [{ Update: {} }] },
        [
    ...
    it("should return ValidationException for repeated GlobalSecondaryIndexUpdates", function (done) {
      assertValidation(
        ...
        "One or more parameter values were invalid: " +
          "Only one global secondary index update per index is allowed simultaneously. Index: abc",
        done
      );
    });
    ...
    it("should return ValidationException for PROVISIONED without ProvisionedThroughput", function (done) {
      assertValidation(
        { TableName: helpers.testHashNTable, BillingMode: "PROVISIONED" },
        "One or more parameter values were invalid: " +
    ...
    it("should return NotFoundException for high index ReadCapacityUnits when table does not exist", function (done) {
      assertNotFound(
        ...
        "Requested resource not found: Table: abc not found",
        done
      );
    });
    ...
    it("should return ValidationException for high index ReadCapacityUnits when index does not exist", function (done) {
      assertValidation(
        ...
        "This operation cannot be performed with given input values. Please contact DynamoDB service team for more info: Action Blocked: IndexUpdate",
        done
      );
    });
    ...
    it("should return ValidationException if read and write are same", function (done) {
      request(
        helpers.opts("DescribeTable", { TableName: helpers.testHashTable }),
        function (err, res) {
          if (err) return err(done);
          var readUnits =
            res.body.Table.ProvisionedThroughput.ReadCapacityUnits;
          var writeUnits =
            res.body.Table.ProvisionedThroughput.WriteCapacityUnits;
          assertValidation(
            {
              TableName: helpers.testHashTable,
              ProvisionedThroughput: {
  ...
  describe("functionality", function () {
    it("should triple rates and then reduce if requested", function (done) {
      this.timeout(200000);
      var oldRead = helpers.readCapacity,
        oldWrite = helpers.writeCapacity,
        newRead = oldRead * 3,
        newWrite = oldWrite * 3,
        increase = Date.now() / 1000,
        throughput = {
      ...
      request(
        ...
        function (err, res) {
          ...
          desc.AttributeDefinitions.should.eql([
          ...
          desc.ProvisionedThroughput.LastIncreaseDateTime.should.be.above(
            increase - 5
          );
          ...
          helpers.waitUntilActive(helpers.testHashTable, function (err, res) {
            ...
            desc.ProvisionedThroughput.WriteCapacityUnits.should.equal(
              newWrite
            );
            desc.ProvisionedThroughput.LastIncreaseDateTime.should.be.above(
              increase
            ...
            throughput = {
              ReadCapacityUnits: oldRead,
              WriteCapacityUnits: oldWrite,
            };
            request(
              opts({
                TableName: helpers.testHashTable,
              ...
              function (err, res) {
                ...
                desc.ProvisionedThroughput.LastIncreaseDateTime.should.equal(
                  increase
                );
                desc.ProvisionedThroughput.LastDecreaseDateTime.should.be.above(
                  decrease - 5
                );
                desc.ProvisionedThroughput.NumberOfDecreasesToday.should.equal(
                  numDecreases
                );
                desc.ProvisionedThroughput.ReadCapacityUnits.should.equal(
                  newRead
                );
                desc.ProvisionedThroughput.WriteCapacityUnits.should.equal(
                  newWrite
    ...
    it.skip("should allow table to be converted to PAY_PER_REQUEST and back again", function (done) {
      ...
      var read = helpers.readCapacity,
        write = helpers.writeCapacity,
        throughput = { ReadCapacityUnits: read, WriteCapacityUnits: write },
        decrease = Date.now() / 1000;
      request(
        opts({
        ...
        function (err, res) {
          ...
          var desc = res.body.TableDescription;
          desc.TableStatus.should.equal("UPDATING");
          desc.BillingModeSummary.should.eql({
            BillingMode: "PAY_PER_REQUEST",
          });
          desc.TableThroughputModeSummary.should.eql({
          ...
          helpers.waitUntilActive(helpers.testRangeTable, function (err, res) {
            ...
            desc.BillingModeSummary.LastUpdateToPayPerRequestDateTime.should.be.above(
              decrease - 5
            );
            desc.TableThroughputModeSummary.TableThroughputMode.should.equal(
              "PAY_PER_REQUEST"
            );
            desc.TableThroughputModeSummary.LastUpdateToPayPerRequestDateTime.should.be.above(
              decrease - 5
            );
            desc.ProvisionedThroughput.NumberOfDecreasesToday.should.be.above(
              -1
            );
            desc.ProvisionedThroughput.ReadCapacityUnits.should.equal(0);
            desc.ProvisionedThroughput.WriteCapacityUnits.should.equal(0);
            desc.GlobalSecondaryIndexes.forEach(function (index) {
              index.ProvisionedThroughput.LastDecreaseDateTime.should.be.above(
                decrease - 5
              );
              index.ProvisionedThroughput.NumberOfDecreasesToday.should.be.above(
                0
              );
            ...
            assertValidation(
              ...
              "One or more parameter values were invalid: " +
                "ProvisionedThroughput must be specified for index: index3,index4",
              function (err) {
                if (err) return done(err);
                ...
                request(
                  ...
                  function (err, res) {
                    ...
                    var desc = res.body.TableDescription;
                    desc.TableStatus.should.equal("UPDATING");
                    desc.BillingModeSummary.BillingMode.should.equal(
                      "PROVISIONED"
                    );
                    desc.BillingModeSummary.LastUpdateToPayPerRequestDateTime.should.be.above(
                      decrease - 5
                    ...
                    desc.GlobalSecondaryIndexes.forEach(function (index) {
                      ...
                      index.ProvisionedThroughput.ReadCapacityUnits.should.equal(
                        read
                      );
                      index.ProvisionedThroughput.WriteCapacityUnits.should.equal(
                        write
                      );
                    });
