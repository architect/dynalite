...
describe("scan", function () {
  describe("serializations", function () {
    ...
    it("should return SerializationException when ScanFilter.Attr.AttributeValueList.0 is not an attr struct", function (done) {
      this.timeout(60000);
      assertType(
        "ScanFilter.Attr.AttributeValueList.0",
  ...
  describe("validations", function () {
      ...
      assertValidation(
        {
          ...
          Select: "hi",
          Limit: -1,
          ScanFilter: { a: {}, b: { ComparisonOperator: "" } },
          ConditionalOperator: "AN",
      ...
      assertValidation(
        {
          ...
          ScanFilter: {
            a: {
              ...
              AttributeValueList: [{}, { a: "" }, { S: "" }],
            },
          },
          ExclusiveStartKey: { a: {} },
          AttributesToGet: ["a", "a"],
        },
        "One or more parameter values were invalid: Duplicate value in attribute name: a",
        done
      );
    });
    ...
    it("should return ValidationException for invalid values in ScanFilter", function (done) {
      async.forEach(
        [
          ...
          [
            { BS: ["Yg==", "Yg=="] },
            "Input collection [Yg==, Yg==]of type BS contains duplicates.",
          ],
        ],
        function (expr, cb) {
          assertValidation(
            {
              ...
              ScanFilter: {
                a: {
                  ComparisonOperator: "EQ",
                  AttributeValueList: [{ N: "1" }, expr[0], {}],
                },
              },
            },
            "One or more parameter values were invalid: " + expr[1],
            cb
          );
        },
        done
    ...
    it("should return ValidationException for empty/invalid numbers in ScanFilter", function (done) {
      async.forEach(
        [
          ...
          [
            { N: "-1.23456789012345678901234567890123456789" },
            "Attempting to store more than 38 significant digits in a Number",
          ],
          [
            { N: "1e126" },
      ...
      assertValidation(
        {
          ...
          ScanFilter: {
            a: {
              ComparisonOperator: "EQ",
              AttributeValueList: [{ N: "1" }, { S: "a", N: "1" }],
            },
          },
        },
        ...
        [
          ...
          },
          {
            a: {
              ...
              AttributeValueList: [{ S: "a" }, { S: "a" }, { S: "a" }],
            },
          },
        ],
        function (expr, cb) {
              ...
              assertValidation(
                {
                  ...
                  ExclusiveStartKey: { a: {} },
                  ScanFilter: {
                    a: { ComparisonOperator: cond, AttributeValueList: list },
                  },
                },
          ...
          assertValidation(
            {
              ...
              ExclusiveStartKey: { a: {} },
              ScanFilter: {
                a: { ComparisonOperator: "BETWEEN", AttributeValueList: list },
              },
            },
            "One or more parameter values were invalid: " +
      ...
      assertValidation(
        {
          ...
          ScanFilter: {
            a: {
              ComparisonOperator: "EQ",
              AttributeValueList: [{ SS: ["a"] }],
            },
          },
        },
        "The provided starting key is invalid: Supplied AttributeValue is empty, must contain exactly one of the supported datatypes",
        done
      );
    });
    ...
    it("should return ValidationException for Segment more than TotalSegments", function (done) {
      assertValidation(
        ...
        "The Segment parameter is zero-based and must be less than parameter TotalSegments: Segment: 1 is not less than TotalSegments: 1",
        done
      );
    });
    ...
    it("should return ValidationException for invalid ExpressionAttributeNames", function (done) {
      assertValidation(
        ...
        'ExpressionAttributeNames contains invalid key: Syntax error; key: "a"',
        done
      );
    });
    ...
    it("should return ValidationException for invalid ExpressionAttributeValues", function (done) {
      assertValidation(
        ...
        'ExpressionAttributeValues contains invalid key: Syntax error; key: "a"',
        done
      );
    });
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: Invalid function name; function: " +
              expr[1],
            cb
          );
        },
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: The function is not allowed to be used this way in an expression; function: " +
              expr[1],
            cb
          );
        },
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: Attribute name is a reserved keyword; reserved keyword: " +
              expr[1],
            cb
          );
        },
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: An expression attribute name used in the document path is not defined; attribute name: " +
              expr[1],
            cb
          );
        },
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: An expression attribute value used in expression is not defined; attribute value: " +
              expr[1],
            cb
          );
        },
    ...
    it("should return ValidationException for functions with incorrect operand type", function (done) {
      var expressions = [
        ...
        [
          "attribute_type(a, size(a)) and a=a and a=:a",
          "attribute_type",
          { N: "1" },
        ],
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "Invalid FilterExpression: Operator or function requires a document path; operator or function: " +
              expr[1],
            cb
          );
        },
    ...
    it("should return ValidationException for non-distinct expressions", function (done) {
      var expressions = [
        ...
        [
          "attribute_type(ab.bc[1].#a, ab.bc[1].a)",
          "attribute_type",
          "[ab, bc, [1], a]",
        ],
        [
          "begins_with(ab.bc[1].a, ab.bc[1].#a)",
          "begins_with",
          "[ab, bc, [1], a]",
        ],
        // ':a > :a', ... is ok
      ...
      async.forEach(
        ...
        function (expr, cb) {
          assertValidation(
            ...
            "The table does not have the specified index: whatever",
            cb
          );
        },
        done
    ...
    it("should return ValidationException for non-existent index name", function (done) {
      async.forEach(
        [helpers.testHashTable, helpers.testRangeTable],
        function (table, cb) {
          assertValidation(
            {
              TableName: table,
    ...
    it("should return ValidationException if ExclusiveStartKey is from different segment", function (done) {
      ...
      for (i = 0; i < 10; i++) items.push({ a: { S: String(i) } });
      ...
      async.forEach(
        ...
        function (expression, cb) {
          assertValidation(
            ...
            "Key attributes must be scalars; list random access '[]' and map lookup '.' are not allowed: Key: a",
            cb
          );
        },
        done
  ...
  describe("functionality", function () {
    it("should scan with no filter", function (done) {
      ...
      request(
        ...
        function (err, res) {
          ...
          res.statusCode.should.equal(200);
          request(
            opts({ TableName: helpers.testHashTable }),
            function (err, res) {
              if (err) return done(err);
              res.statusCode.should.equal(200);
        ...
        async.forEach(
          [
            ...
            },
            {
              ...
              ExpressionAttributeValues: { ":b": item.b },
            },
          ],
          function (scanOpts, cb) {
            scanOpts.TableName = helpers.testHashTable;
    ...
    it("should scan by LE on type B", function (done) {
      var item = {
        ...
        item2 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("d0", "hex").toString("base64") },
          c: item.c,
        },
        item3 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("cf", "hex").toString("base64") },
          c: item.c,
        },
        item4 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("d000", "hex").toString("base64") },
          c: item.c,
        },
        item5 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("cfff", "hex").toString("base64") },
          c: item.c,
        },
        batchReq = { RequestItems: {} };
      batchReq.RequestItems[helpers.testHashTable] = [
    ...
    it("should scan by CONTAINS on type S", function (done) {
      var item = {
        ...
        item3 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("abdef").toString("base64") },
          c: item.c,
        },
        item4 = {
          a: { S: helpers.randomString() },
    ...
    it("should scan by CONTAINS on type N", function (done) {
      var item = {
        ...
        item3 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("1234").toString("base64") },
          c: item.c,
        },
        item4 = {
          a: { S: helpers.randomString() },
          b: { BS: [Buffer.from("234").toString("base64")] },
          c: item.c,
        },
        item5 = {
          a: { S: helpers.randomString() },
    ...
    it("should scan by CONTAINS on type B", function (done) {
      var item = {
        ...
        item5 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("bde").toString("base64") },
          c: item.c,
        },
        item6 = {
          a: { S: helpers.randomString() },
        ...
        item7 = {
          a: { S: helpers.randomString() },
          b: {
            L: [{ N: "123" }, { B: Buffer.from("bde").toString("base64") }],
          },
          c: item.c,
        },
        item8 = {
          a: { S: helpers.randomString() },
          b: { L: [{ B: Buffer.from("abd").toString("base64") }] },
          c: item.c,
        },
        item9 = {
          a: { S: helpers.randomString() },
    ...
    it("should scan by BEGINS_WITH on type B", function (done) {
      var item = {
        ...
        item5 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("abd").toString("base64") },
          c: item.c,
        },
        batchReq = { RequestItems: {} };
      batchReq.RequestItems[helpers.testHashTable] = [
          ...
          [
            {
              ScanFilter: {
                b: {
                  ...
                  AttributeValueList: [item5.b, item.b],
                },
                c: { ComparisonOperator: "EQ", AttributeValueList: [item.c] },
              },
            },
          ...
          [
            {
              ScanFilter: {
                b: {
                  ComparisonOperator: "IN",
                  AttributeValueList: [item4.b, item5.b],
                },
                c: { ComparisonOperator: "EQ", AttributeValueList: [item.c] },
              },
            },
    ...
    it("should scan by IN on type B", function (done) {
      var item = {
        ...
        item2 = {
          a: { S: helpers.randomString() },
          b: { BS: [Buffer.from("1234").toString("base64")] },
          c: item.c,
        },
        item3 = {
          a: { S: helpers.randomString() },
        ...
        item5 = {
          a: { S: helpers.randomString() },
          b: { B: Buffer.from("12345").toString("base64") },
          c: item.c,
        },
        batchReq = { RequestItems: {} };
      batchReq.RequestItems[helpers.testHashTable] = [
          ...
          [
            {
              ScanFilter: {
                b: {
                  ComparisonOperator: "IN",
                  AttributeValueList: [item3.b, item5.b],
                },
                c: { ComparisonOperator: "EQ", AttributeValueList: [item.c] },
              },
            },
          ...
          [
            {
              ScanFilter: {
                b: {
                  ComparisonOperator: "BETWEEN",
                  AttributeValueList: [item2.b, item4.b],
                },
                c: { ComparisonOperator: "EQ", AttributeValueList: [item.c] },
              },
            },
          ...
          [
            {
              ScanFilter: {
                b: {
                  ComparisonOperator: "BETWEEN",
                  AttributeValueList: [item5.b, item4.b],
                },
                c: { ComparisonOperator: "EQ", AttributeValueList: [item.c] },
              },
            },
    ...
    it("should scan by nested properties", function (done) {
      ...
      var item2 = {
        a: { S: helpers.randomString() },
        b: { L: [{ S: helpers.randomString() }, item.b] },
        c: item.c,
      };
      var item3 = {
        a: { S: helpers.randomString() },
      ...
      request(helpers.opts("BatchWriteItem", batchReq), function (err, res) {
        ...
        async.forEach(
          [
            ...
            {
              FilterExpression:
                "(attribute_exists(b.a) OR attribute_exists(b[1])) AND c = :c",
              ExpressionAttributeValues: { ":c": item.c },
            },
            {
              FilterExpression:
                "(attribute_type(b.a, :m) OR attribute_type(b[1].a, :m)) AND c = :c",
        ...
        async.forEach(
          ...
          function (scanOpts, cb) {
            ...
            request(opts(scanOpts), function (err, res) {
              if (err) return cb(err);
              res.statusCode.should.equal(200);
              res.body.Items.should.containEql({
                b: { S: "b1" },
                d: { S: "d1" },
              });
    ...
    it("should return after but not including ExclusiveStartKey", function (done) {
      var i,
        ...
        batchReq = { RequestItems: {} },
        scanFilter = {
          b: { ComparisonOperator: "EQ", AttributeValueList: [b] },
        };

      for (i = 0; i < 10; i++) items.push({ a: { S: String(i) }, b: b });
      ...
      request(helpers.opts("BatchWriteItem", batchReq), function (err, res) {
        ...
        request(
          opts({ TableName: helpers.testHashTable, ScanFilter: scanFilter }),
          function (err, res) {
            if (err) return done(err);
            res.statusCode.should.equal(200);
    ...
    it("should return LastEvaluatedKey if Limit not reached", function (done) {
      ...
      for (i = 0; i < 5; i++) items.push({ a: { S: String(i) }, b: b });
    ...
    it("should return LastEvaluatedKey even if selecting Count", function (done) {
      ...
      request(helpers.opts("BatchWriteItem", batchReq), function (err, res) {
        ...
        request(
          opts({ TableName: helpers.testHashTable, Limit: 3, Select: "COUNT" }),
          function (err, res) {
            if (err) return done(err);
            res.statusCode.should.equal(200);
            res.body.ScannedCount.should.equal(3);
    ...
    it("should return LastEvaluatedKey while filtering, even if Limit is smaller than the expected return list", function (done) {
      ...
      // regard...
      for (i = 0; i < 25; i++) items.push({ a: { S: "item" + i } });
    ...
    it("should return items in same segment order", function (done) {
      ...
      for (i = 0; i < 20; i++) items.push({ a: { S: String(i) }, b: b });
              ...
              function (err, res) {
                ...
                request(
                  ...
                  function (err, res) {
                    ...
                    res.body.Items.forEach(function (item) {
                      firstHalf.should.containEql(item);
                    });
                      ...
                      function (err, res) {
                        ...
                        request(
                          ...
                          function (err, res) {
                            ...
                            res.body.Items.forEach(function (item) {
                              secondHalf.should.containEql(item);
                            });
    ...
    it("should return items in number hash order", function (done) {
      ...
      for (i = 0; i < 10; i++) items.push({ a: { N: String(i) }, b: b });
      ...
      batchReq.RequestItems[helpers.testHashNTable] = items.map(function (
        item
      ) {
        return { PutRequest: { Item: item } };
      });
      ...
      request(helpers.opts("BatchWriteItem", batchReq), function (err, res) {
        ...
        request(
          opts({ TableName: helpers.testHashNTable, ScanFilter: scanFilter }),
          function (err, res) {
            if (err) return done(err);
            res.statusCode.should.equal(200);
            res.body.Count.should.equal(14);
    ...
    it.skip("should not return LastEvaluatedKey if just under limit for range table", function (done) {
      ...
      var i,
        ...
        e = new Array(41583).join("e"),
        eAttr = e.slice(0, 255);
      for (i = 0; i < 25; i++) {
        var item = {
          a: { S: id },
          b: { S: ("000000" + i).slice(-6) },
          c: { S: "abcde" },
        };
        item[eAttr] = { S: e };
        items.push(item);
    ...
    it.skip("should return all if just under limit with small attribute for hash table", function (done) {
      ...
      var i,
        items = [];
      for (i = 0; i < 25; i++) items.push({ a: { S: ("0" + i).slice(-2) } });
    ...
    it.skip("should return all if just under limit for range table", function (done) {
      ...
      helpers.replaceTable(
        ...
        function (err) {
          ...
          request(
            opts({ TableName: helpers.testRangeTable }),
            function (err, res) {
              if (err) return done(err);
              res.statusCode.should.equal(200);
              items = res.body.Items;
                ...
                function (err) {
                  ...
                  request(
                    ...
                    function (err, res) {
                      ...
                      res.body.ScannedCount.should.equal(24);
                      res.body.Count.should.equal(24);
                      res.body.ConsumedCapacity.CapacityUnits.should.equal(
                        127.5
                      );
                      helpers.clearTable(
                        helpers.testRangeTable,
