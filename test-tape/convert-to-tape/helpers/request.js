...
function request (callOpts, cb) {
  ...
  // Only sign if using remote DynamoDB and noSign is not explicitly set
  // For local Dynalite, sign with dummy credentials to satisfy potential header requirements
  if (!finalOpts.noSign) {
